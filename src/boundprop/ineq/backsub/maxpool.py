...
_A_fp32 = torch.ones((2, 3, 4), dtype=torch.float32)
_b_fp32 = torch.ones((2,), dtype=torch.float32)
_s1_fp32 = torch.ones((3, 4, 5), dtype=torch.float32)
_s2_fp32 = torch.ones((3, 4, 5), dtype=torch.float32)
_t1_fp32 = torch.ones((3, 4), dtype=torch.float32)
_t2_fp32 = torch.ones((3, 4), dtype=torch.float32)

_A_4d_fp32 = torch.ones((2, 3, 4, 5), dtype=torch.float32)
_b_4d_fp32 = torch.ones((2, 3), dtype=torch.float32)
_s1_4d_fp32 = torch.ones((2, 4, 5, 2), dtype=torch.float32)
_s2_4d_fp32 = torch.ones((2, 4, 5, 2), dtype=torch.float32)
_t1_4d_fp32 = torch.ones((2, 4, 5), dtype=torch.float32)
_t2_4d_fp32 = torch.ones((2, 4, 5), dtype=torch.float32)

_A_fp64 = torch.ones((2, 3, 4), dtype=torch.float64)
_b_fp64 = torch.ones((2,), dtype=torch.float64)
_s1_fp64 = torch.ones((3, 4, 5), dtype=torch.float64)
_s2_fp64 = torch.ones((3, 4, 5), dtype=torch.float64)
_t1_fp64 = torch.ones((3, 4), dtype=torch.float64)
_t2_fp64 = torch.ones((3, 4), dtype=torch.float64)

_A_4d_fp64 = torch.ones((2, 3, 4, 5), dtype=torch.float64)
_b_4d_fp64 = torch.ones((2, 3), dtype=torch.float64)
_s1_4d_fp64 = torch.ones((2, 4, 5, 2), dtype=torch.float64)
_s2_4d_fp64 = torch.ones((2, 4, 5, 2), dtype=torch.float64)
_t1_4d_fp64 = torch.ones((2, 4, 5), dtype=torch.float64)
_t2_4d_fp64 = torch.ones((2, 4, 5), dtype=torch.float64)
